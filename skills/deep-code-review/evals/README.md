...
2. Ask for the review mode stated by the case and no code modifications.
...
- anchor findings to the mode-appropriate changed or current cause
- separate pre-existing defects in `change_review` without excluding current defects from `full_audit`
